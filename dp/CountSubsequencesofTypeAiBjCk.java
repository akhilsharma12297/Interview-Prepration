...
public class CountSubsequencesofTypeAiBjCk {
	static int countSubsequences(String s) {
		...
		for (int i = 0; i < s.length(); i++) {
			...
			/*
			 * If current character is 'b', then there are following possibilities : a)
			 * Current character begins a new subsequence of b's with aCount subsequences.
			 * b) Current character is part of bCount subsequences. c) Current character is
			 * not part of bCount subsequences.
			 */
			else if (s.charAt(i) == 'b')
				bCount = (aCount + 2 * bCount);

			/*
			 * If current character is 'c', then there are following possibilities : a)
			 * Current character begins a new subsequence of c's with bCount subsequences.
			 * b) Current character is part of cCount subsequences. c) Current character is
			 * not part of cCount subsequences.
			 */
